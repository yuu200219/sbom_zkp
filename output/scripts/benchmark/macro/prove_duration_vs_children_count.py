...
def main():
    ...
    sns.lineplot(data=df_agg, x='children_count', y='total_prove_duration', color='darkcyan', marker='o', linewidth=2.5, label='Avg Proving Duration', ax=ax1)
    
    ax1.set_title("Proving Duration vs Children Count")
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(OUTPUT_DIR, 'prove_duration_vs_children_count.png'), dpi=300, bbox_inches='tight')
    print("Saved prove_duration_vs_children_count.png")
