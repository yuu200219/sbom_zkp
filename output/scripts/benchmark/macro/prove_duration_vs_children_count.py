...
def main():
    ...
    sns.scatterplot(data=df, x='children_count', y='pure_prove_duration', hue='source', palette='viridis', alpha=0.7, ax=ax1)
    sns.lineplot(data=df_agg, x='children_count', y='pure_prove_duration', color='darkcyan', marker='o', linewidth=2.5, label='Avg Proving Duration', ax=ax1)
