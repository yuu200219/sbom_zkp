...
CSV_FILES = [
    ...
    os.path.join(SCRIPT_DIR, '../../../CSV/recursive-opt/never_seen/flask_experiment_log.csv')
]
...
def main():
    ...
    sns.lineplot(data=df_agg, x='descendants_count', y='total_prove_duration', color='darkcyan', marker='o', linewidth=2.5, label='Avg Total Proving Duration', ax=ax1)
    
    ax1.set_title("End-to-End Proving Duration vs Descendants Count")
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(OUTPUT_DIR, 'total_prove_duration_vs_descendants_count.png'), dpi=300, bbox_inches='tight')
    print("Saved total_prove_duration_vs_descendants_count.png")
